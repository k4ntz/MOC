...
table = pd.read_csv(f"../aiml_atari_data/rgb/MsPacman-v0/{folder}_labels.csv")
...
for i in tqdm(range(nb_images)):
    ...
    img_path = f"../aiml_atari_data/space_like/MsPacman-v0/{folder}/{i:05}.png"
    img_path_fs = f"../aiml_atari_data/rgb/MsPacman-v0/{folder}/{i:05}.png"
